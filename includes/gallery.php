        ...
        <div class="wrap">
            ...
            <div class="block">
                ...
                <div class="content">
                    ...
                    <h5 class="title">Project 6</h5>
                </div>
            </div>
        </div>
        <div class="button-all">
            <a href="our_projects" class="btn btn-custom-small btn-primary">Load More</a>
        </div>
    </div>
</section>